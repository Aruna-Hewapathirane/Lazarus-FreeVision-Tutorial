...
(*
Add buttons to the dialog.
With <b>Insert</b> you add the components, in this case they are the buttons.
With bfDefault you set the default button, which is activated with <b>[Enter]</b>.
bfNormal is a normal button.
The dialog is now opened modal, so <b>no</b> further dialogs can be opened.
dummy has the value of the button that was pressed, this corresponds to the <b>cmxxx</b> value.
The height of the buttons must always be <b>2</b>, otherwise there will be an incorrect display.
*) 
//code+ 
